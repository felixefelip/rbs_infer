...
#     Expanded view of sig/generated/steep_actiontext_runtime/attribute.rb (macros desugared into pseudo-code).
...
module ActionText::Attribute::ClassMethods
  # @type instance: singleton(::ActiveRecord::Base) & ::ActionText::Attribute::ClassMethods
  # @rbs_infer no-signature
  def has_rich_text(name, encrypted: false, strict_loading: strict_loading_by_default, store_if_blank: true)
    class_eval <<-CODE, __FILE__, __LINE__ + 1
          def #{name}
